import random
from imagenet_final_FI import get_model_from_name, get_fault_injection_configs
...
def main():
    ...
    for model_name in model_names:
        ...
        data = []
        file1 = open('../dataset/imagenet/result/' + dataset_name + '_final_log_' + model_name+ '_' + str(i) + '.txt', 'r')
        ...
        for i in range(len(correct_indices)):
            ...
            fi_taken_image_index += 1


        benign_count, faulty_avmis, faulty_non_avmis = get_statistics_per_image_with_fault_injection(prev_pred_list, faulty_list)
