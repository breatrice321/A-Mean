...
def main(model,process_no):
    model_name = model
    file_object = open('../dataset/CIFAR10/result/' + model_name + '/cifar10_final_log_' + model_name + '_' + str(process_no) + '.txt', 'a')
    inputs = np.load("../dataset/CIFAR10/cifar10_test_images.npy")
    labels = np.load("../dataset/CIFAR10/cifar10_test_labels.npy")
