...
def find_avmis(main_class, predicted_class):
    type1_super_groups = ['automobile', 'deer', 'horse', 'truck']
    type2_super_groups = ['airplane', 'bird', 'cat', 'dog', 'frog', 'ship']
...
def main():
    ...
    model_names = ['VGG16', 'VGG19', 'MobileNet', 'ResNet50', 'MobileNetV2']
    model_list = []
    data_list = []
    for model_name in model_names:
        model_list.append(model_name)
        data = []
        file1 = open('../dataset/CIFAR10/' + dataset_name + '_final_log_' + model_name + '.txt', 'r')
